...
it('can add the star name and star symbol properly', async() => {
    ...
    let user = accounts[1];
    let starId = 25;
    await instance.createStar('bright star', starId, {from: user});
    //2. Call the name and symbol properties in your Smart Contract and compare with the name and symbol provided
    assert.equal(await instance.tokenName(), 'Udactity Token');
    assert.equal(await instance.tokenSymbol(), 'UDC');
});
...
it('lets 2 users exchange stars', async() => {
    ...
    let starId1 = 15;
    let starId2 = 16;
    await instance.createStar('bright star', starId1, {from: user1});
    await instance.createStar('dark star', starId2, {from: user2});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    assert.equal('dark star', starName);
});